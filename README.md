...
DUF Tech Mülakat Asistanı, mülakat süreçlerini otomatikleştirmek ve yönetmek için tasarlanmış bir web uygulamasıdır. Mülakatçıların CV'lerini analiz edebilir, mülakat sorularını otomatik olarak oluşturabilir ve mülakat sırasında ses tanıma ve yapay zeka destekli yanıt değerlendirme yapabilir.

### 🎯 Temel Amaçlar
- Aday CV'lerini otomatik analiz etme ve pozisyona uygun değerlendirme
- Adayın deneyim ve yeteneklerine göre özel mülakat soruları oluşturma
- Gerçek zamanlı ses tanıma ile adayın yanıtlarını metne dönüştürme
- Yapay zeka destekli yanıt değerlendirme
- Mülakat sırasında otomatik fotoğraf çekimi ve duygu analizi
- Mülakat sonunda otomatik rapor oluşturma
- Otomatik ve manuel mülakat modları
